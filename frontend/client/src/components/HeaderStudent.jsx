  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white shadow-lg z-50">
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="text-xl font-bold text-blue-700">Attentify</Link>
      ...
      >
        ...
        <ul className="p-4 space-y-4">
          ...
          <li>
            <Link onClick={closeTaskbar} to="/student/timetable" className="flex items-center gap-2">
              <FaTable /> Time Table
            </Link>
          </li>

          <li>
            <Link onClick={closeTaskbar} to="/student/attendance" className="flex items-center gap-2">
              <IoMdCheckmarkCircleOutline /> Attendance
            </Link>
          </li>

          <li>
            <Link onClick={closeTaskbar} to="/student/medical" className="flex items-center gap-2">
              <BiSpreadsheet /> Medical Report
            </Link>
          </li>

          <li>
            <Link onClick={closeTaskbar} to="/student/profile" className="flex items-center gap-2">
              <FaRegUser /> Profile
            </Link>
          </li>
