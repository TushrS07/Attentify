...
export const BarChart = ({ data, width = 520, height = 180, color = 'var(--indigo-700)', color2, max }) => {
...
export const LineChart = ({ data, width = 520, height = 180, color = 'var(--indigo-600)' }) => {
...
export const Donut = ({ slices, size = 160, thickness = 22, center }) => {
  const r = size/2 - 2;
...
export const Pie = ({ slices, size = 140 }) => {
