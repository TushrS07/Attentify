  ...
  return (
    <footer className="mt-4 bgf text-gray-700 shadow-inner px-10 py-16 ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
        ...
        {/* Brand Section */}
        <div>
          <h1 className="text-2xl font-bold text-blue-700">Attendify</h1>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-xl text-gray-600">
            <a href="mailto:support@attendify.com" className="hover:text-blue-600"><FaEnvelope /></a>
          ...
          <p className="mt-4 text-sm text-gray-500">&copy; {new Date().getFullYear()} Attendify. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
