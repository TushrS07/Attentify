...
//       const attendanceData = response.data.attendance[0];
//       // console.log("Fetched Attendance:", attendanceData);

//       toast.success("Sheet generated successfully!");

//       // Update state to display the data in a table
//       setAttendanceRecords(attendanceData);

//       // Reset the fields after generating
//       // setSelectedSubject("");
//       // setSelectedGroup("");
//       // setSelectedDate("");
//       // setSelectedLectureSlot("");
...
//     const data = attendanceRecords.attendance.map(record => ({
//       "Roll Number": record.studentId,
//       "Attendance Status": record.status,
//       "Lectures": attendanceRecords.lectures,  // Adding lectures
//       "Section ID": attendanceRecords.sectionId,  // Adding sectionId
//       "Subject ID": attendanceRecords.subjectId,  // Adding subjectId
//       "Teacher ID": attendanceRecords.teacherId,  // Adding teacherId
//     }));
...
//     XLSX.writeFile(wb, `${selectedSubject}_${selectedGroup}_attendance.xlsx`);
...
//                     <th className="border p-2 text-left">Attendance Status</th>
//                   </tr>
//                 </thead>
//                 <tbody>
...
//                       <td className="border p-2">{record.studentId.rollNumber}</td>
